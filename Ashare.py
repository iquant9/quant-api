...
def get_price_plus(code, end_date='',count=10, frequency='1d', fields=[]):
    df=get_price(code,end_date,count, frequency, fields)
    df['dt']=df.index.astype(str)
    return df
if __name__ == '__main__':
    #  000001.XSHG
    df=get_price_plus('sh000001',frequency='5m',count=100000)      #支持'1d'日, '1w'周, '1M'月
    print('上证指数日线行情\n',df)
    ...
    print('个股行情\n', df)
    df = get_price('sz002995', frequency='15m', count=10)  # 支持'1m','5m','15m','30m','60m'
    print('个股行情\n', df)
